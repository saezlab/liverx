...
fdr_thres <- as.double(args[1])
message(paste('FDR threshold set to:', fdr_thres))
...
# Import network
network <- loadNetwork.tab('files/genemania_mouse_network_filtered.txt', header=T, directed=F, format='graphNEL')
